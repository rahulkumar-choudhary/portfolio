  ...
  return (
    <main className="flex flex-col min-h-[100dvh] space-y-10 w-full px-4 md:px-8">
        ...
        <div className="flex flex-col gap-4 backdrop-blur-md bg-background/60 rounded-2xl border border-white/20 px-4 py-8 shadow-lg hover:shadow-xl transition-all">
          {[
            ...
            >
              ...
              <span className="text-lg group-hover:text-gray-800 transition-colors">
                {item.icon}
              </span>
      ...
      <div className="flex justify-center gap-4 flex-wrap lg:hidden sticky top-0 z-50 w-full bg-white/90 backdrop-blur-md py-4 px-4 border-b border-gray-200">
        <Link
          href="/about"
          className="group relative inline-flex items-center justify-center px-4 py-2 text-sm font-medium transition-all rounded-xl bg-gray-50 hover:bg-gray-100 border border-gray-200 hover:border-gray-300"
        >
          ...
          <BlurFade delay={BLUR_FADE_DELAY * 11}>
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  I&apos;ve worked on a variety of projects, from Kubernetes to
                  AWS to open source contributions.{" "}
                  <Link
                    href="/projects"
                    className="text-blue-500 hover:underline inline-flex items-center gap-1"
                  >
            ...
            {[
              {
                ...
                image: "/ddos.png",
                github:
                  "https://github.com/rahulkumar-choudhary/DDoS-attack-surveillance",
              },
              {
                ...
                github:
                  "https://github.com/rahulkumar-choudhary/Kubernetes_MultiNode_Cluster_Automation",
              },
            ].map((project, id) => (
              <BlurFade
                key={project.title}
          ...
          <BlurFade delay={BLUR_FADE_DELAY * 14}>
            <div className="flex flex-col items-center justify-center space-y-6 text-center">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  I write about technology, development, and my experiences
                  building products.{" "}
                  <Link
                    href="/blog"
                    className="text-blue-500 hover:underline inline-flex items-center gap-1"
            ...
            {[
              {
                ...
                description:
                  "Learn about system resource limits in Docker containers and how to configure them properly using Nginx and FastCGI.",
              ...
              },
              {
                ...
                description:
                  "A comprehensive guide on using aws-nuke tool to remove all resources from an AWS account safely and efficiently.",
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  ...
                  {DATA.hackathons.length}+ hackathons. In two to three days,
                  people from all around the nation would come together and
                  create amazing things. Seeing the limitless potential realized
                  by a bunch of driven and enthusiastic people was eye-opening.
                </p>
              </div>
            </div>
          </BlurFade>
            ...
            <div className="space-y-6">
              <div className="space-y-3">
                ...
                <p className="mx-auto max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Feel free to reach out through any of these platforms. I am
